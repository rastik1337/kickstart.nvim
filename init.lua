...
vim.keymap.set('n', '<leader>cp', '<cmd>cprev<CR>', { desc = '[P]revious quickfix list entry' })
vim.keymap.set('n', '<leader>cn', '<cmd>cnext<CR>', { desc = '[N]ext quickfix list entry' })
...
-- Better jumping to start/end of line
vim.keymap.set('n', 'L', '$')
vim.keymap.set('n', 'H', '^')
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>cc', builtin.git_commits, { desc = '[C]heckout [C]ommit' })
  ...
  { 'numToStr/Comment.nvim', opts = {} },
  {
    ...
    config = function()
      ...
      local legacy_servers = { 'tailwindcss' }
      for server_name, config in pairs(servers) do
        if vim.tbl_contains(legacy_servers, server_name) then
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      require('luasnip.loaders.from_vscode').load_standalone { path = './lua/custom/snippets/snippets.code-snippets' }
